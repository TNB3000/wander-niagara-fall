...
module.exports = {
  ...
  widgets: {
    HOME_EAT_DRINK:       { label: "Whereabouts — home: eat & drink widget", embed: `<whereabouts-operators-widget widget-id="6aa193dcc6852ea15eb96042" access-id="6a733c9f069c5aa5556f466c"></whereabouts-operators-widget><script src="https://api.prod.next.whereabouts.tech/embeddable/widget/operator/main.js" type="module"></script>` },
    HOME_OUTDOORS:        { label: "Whereabouts — home: outdoors widget", embed: `<whereabouts-operators-widget widget-id="6a9f8c39c06fe9442efb3e71" access-id="6a733c9f069c5aa5556f466c"></whereabouts-operators-widget><script src="https://api.prod.next.whereabouts.tech/embeddable/widget/operator/main.js" type="module"></script>` },
    ...
    FAMILY_FARMS_MARKETS: { label: "Whereabouts — family farms & markets widget", embed: `<whereabouts-operators-widget widget-id="6aa192fec6852ea15eb8664e" access-id="6a733c9f069c5aa5556f466c"></whereabouts-operators-widget><script src="https://api.prod.next.whereabouts.tech/embeddable/widget/operator/main.js" type="module"></script>` },
    FAMILY_ATTRACTIONS:   { label: "Whereabouts — family museums & attractions widget", embed: `<whereabouts-operators-widget widget-id="6aa19374c6852ea15eb90236" access-id="6a733c9f069c5aa5556f466c"></whereabouts-operators-widget><script src="https://api.prod.next.whereabouts.tech/embeddable/widget/operator/main.js" type="module"></script>` },
    ...
    CF_FARMS_MARKETS:     { label: "Whereabouts — couples & friends farms & markets widget (shares the family farms & markets list)", embed: `<whereabouts-operators-widget widget-id="6aa192fec6852ea15eb8664e" access-id="6a733c9f069c5aa5556f466c"></whereabouts-operators-widget><script src="https://api.prod.next.whereabouts.tech/embeddable/widget/operator/main.js" type="module"></script>` },
